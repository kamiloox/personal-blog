...
Have you ever used a method split, splice, or slice? If you had and you have never looked in documentation while using it, you are a lucky guy. I always need to take a look because all of them sound similar. However, maybe there is a way how to differentiate them? Let's see.
